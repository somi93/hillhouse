    ...
    <section class="pricing-tiers">
      <v-container>
        <div class="content-shell">
          ...
          <div class="pricing-note">{{ $t("pricingPage.hh1DailyRentNote") }}</div>
        </div>
      </v-container>
    </section>
    ...
    <section class="pricing-policies">
      <v-container>
        <div class="content-shell">
          ...
          <div class="policy-note">{{ $t("pricingPage.equipmentPolicy") }}</div>
        </div>
      </v-container>
    </section>
...
@media (max-width: 960px) and (min-width: 600px) {
  ...
  .pricing-grid { grid-template-columns: 1fr; max-width: 520px; margin: 0 auto; gap: 28px; }
